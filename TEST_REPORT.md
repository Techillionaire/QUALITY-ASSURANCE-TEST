...
| F10   | Logout button visibility and functionality             | Should appear on every page, and log out user             | **Only appears on landing page.** Users have to go to landing to log out.                                      | ❌       |
